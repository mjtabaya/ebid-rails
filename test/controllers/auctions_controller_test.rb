...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { bidding_expiration: @auction.bidding_expiration, date_auctioned: @auction.date_auctioned, status: @auction.status, user_id: @auction.user_id } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { bidding_expiration: @auction.bidding_expiration, date_auctioned: @auction.date_auctioned, status: @auction.status, user_id: @auction.user_id } }
